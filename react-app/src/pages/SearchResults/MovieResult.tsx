...
export default function MovieResult(props: MovieResultProps) {
    return (
        <div className="box-content border border-gray-300 hover:bg-mouvise/5 h-40 select-none flex shadow-md shadow-black/20 overflow-clip hover:-translate-0.5 hover:shadow-lg hover:shadow-mouvise/70 hover:border-mouvise hover:text-darkblue hover:cursor-pointer transition-all">
            ...
            <div className="flex flex-col p-3 gap-1 mask-b-from-75% mask-b-to-97%">
