...
export default function MovieResult(props: MovieResultProps) {
    return (
        <div className="border border-gray-300 hover:bg-white h-40 select-none flex shadow-md shadow-black/20 overflow-clip hover:-translate-0.5 hover:shadow-lg hover:shadow-mouvise/70 hover:border-mouvise hover:text-mouvise hover:cursor-pointer transition-all">
