...
export default function PersonResult(props: PersonResultProps) {
    return (
        <div className="box-content rounded-20 border border-gray-300 hover:bg-white h-23 select-none flex shadow-md shadow-black/20 overflow-clip hover:-translate-0.5 hover:shadow-lg hover:shadow-mouvise/50 hover:border-mouvise hover:text-mouvise hover:cursor-pointer transition-all">
