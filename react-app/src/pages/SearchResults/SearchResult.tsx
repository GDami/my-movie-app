...
export default function SearchResult(props: SearchResultProps) {
    return (
        <div className="hover:bg-white h-40 flex gap-3 rounded-20 shadow-sm overflow-clip hover:shadow-lg hover:cursor-pointer transition-shadow">
            <img className="border border-black rounded-20 h-full aspect-23/40 flex justify-center items-center" src={props.imageUrl ? props.imageUrl : undefined} alt={"NO IMG"}></img>
